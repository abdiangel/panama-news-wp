...
function panama_news_scripts() {
	...
	wp_enqueue_script( 'bundle-js', get_template_directory_uri() . '/assets/js/custom.min.js', array('jquery'), null, true );
	wp_enqueue_script( 'bundle-vendor-js', get_template_directory_uri() . '/assets/js/vendor.min.js', array('jquery'), null, true );
